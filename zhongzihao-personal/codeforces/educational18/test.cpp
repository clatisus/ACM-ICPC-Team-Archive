...
// p1p2 is a line while q1q2 is a segment
...
std::vector <P> isCL(P c, double r, P p1, P p2){
...
// convex hull of points in ps counter clockwise
// store answer in qs
...
//convex ps must be counter clockwise
//point p must be out of ps
