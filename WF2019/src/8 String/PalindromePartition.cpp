// Given a string s, find the number of ways to split s to substrings 
// such that if there are k substrings (p1, p2, ..., pk) in partition,
// then pi = pk-i+1 for all i (1 <= i <= k) and k is even.
PalindromicTree pt;
